; extern "C" unsinged long long CountChars_(const char* s, char c);

; Description: this function counts the number of occurrences of a character
; in a string
