; extern "C" size_t ConcactStrings_(char* des, size_t des_size, const char* const* src,
; size_t src_n);

; Returns -1 Invalid 'des_size' n >= 0 Length of concatenated string
